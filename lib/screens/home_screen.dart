...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print('homeProvider.counter ${homeProvider.counter}');
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
            _buildChangeLangButton(tr(LocaleKeys.language_english), englishLocale),
            _buildChangeLangButton(tr(LocaleKeys.language_ukrainian), ukrainianLocale),
          ]),
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Center(child: Text(tr(context.watch<ThemeViewModel>().themeLabel).toUpperCase()))
        ]),
      ),
    );
  }
