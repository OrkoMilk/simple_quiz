...
class HomeDao implements DaoApi<Item?> {
  ...
  final StoreRef<String?, Map<String, Object?>> _homeStore = stringMapStoreFactory.store(homeStore);
  ...
  Future<StreamSubscription> listenToUpdates(Function(DatabaseSnapshotList) onDataChanged) async {
    final db = await _db;
